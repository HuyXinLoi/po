      ...
      <section
        ...
        <div class="md:w-7/12">
          <p class="mb-3 md:mb-7 fadein-left fadeins-1">
            &nbsp; &nbsp; &nbsp; Hi everyone! My name is Dinh Huy. I'm a mobile developer from Gia Lai, Viet Nam. I
            have 1 year of experience in Flutter.
          ...
          <p class="mb-3 fadein-left fadeins-2">
            ...
            In addition, I provide a personal touch to your product and ensure that the app catches attention and is
            easy to use.
