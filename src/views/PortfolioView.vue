      ...
      items: [
        {
          ...
          github: 'https://github.com/HuyXinLoi',
          demo: 'https://dinhhuy.id.vn/'
        },
        {
          id: 2,
          name: 'Optimus Prime Shop',
        ...
        },
        {
          ...
          name: 'SISTEKDES',
          imageUrl: 'sistekdes',
          status: 'A web application to assist village government work in administration, population data management, community services, etc.',
        ...
        },
        {
          ...
          name: 'SP2SE',
          imageUrl: 'sp2se',
          status: 'A web application to manage letters in the village.',
